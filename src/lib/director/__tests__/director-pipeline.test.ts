...
describe('Director Pipeline — Art Direction Config', () => {
  ...
  it('defaults to the storyverse_skills_v2 library default preset', () => {
    ...
    expect(art.defaultVideoModel).toBe('doubao-seedance-2-0-260128')
  })
  ...
  it('updates models independently', () => {
    ...
    expect(useProjectDB.getState().artDirection.defaultVideoModel).toBe('doubao-seedance-2-0-260128') // unchanged
  })
