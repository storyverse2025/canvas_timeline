...
const INTENT_PATTERNS: { pattern: RegExp; skill: string; label: string }[] = [
  ...
  { pattern: /生成关键帧|generate keyframe|创建分镜|storyboard/i, skill: 'generateKeyframes', label: 'Generate Keyframes' },
  ...
  { pattern: /重新生成|regenerate|重做/i, skill: 'regenerate', label: 'Regenerate' },
